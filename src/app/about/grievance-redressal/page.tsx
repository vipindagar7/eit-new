...
const path = "/about/grievance-redressal";

export const metadata = getRouteMetadata(path);

export default function Page() {
  const committee = getCommittee("grievance-redressal");
  ...
  return (
    <>
      <PageHero
        ...
        description="A channel for students and staff to raise and resolve grievances."
        tone="rose"
      />

      <PageSection name="default" eyebrow="Committee" title={["How it", "works"]}>
