...
const path = "/about/internal-committee-women-cell";

export const metadata = getRouteMetadata(path);

export default function Page() {
  const committee = getCommittee("internal-committee-women-cell");
  ...
  return (
    <>
      <PageHero
        ...
        title={["Internal Committee", "and Women Cell"]}
        description="A safe, confidential channel for the prevention and redressal of sexual harassment complaints."
        tone="blush"
      />

      <PageSection name="default" eyebrow="Committee" title={["Purpose and", "composition"]}>
        ...
        {committee && committee.members.length > 0 ? (
          ...
          <SectionNote title="Committee details are being finalised" className="mt-8">
            The committee&apos;s members and contact details will appear here once supplied by the institute. For an
